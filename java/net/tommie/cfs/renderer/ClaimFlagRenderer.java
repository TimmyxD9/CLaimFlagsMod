...
@OnlyIn(Dist.CLIENT)
public class ClaimFlagRenderer extends TileEntityRenderer<ClaimFlagTileEntity> {
    ...
    private final ModelRenderer border;

    public ClaimFlagRenderer(TileEntityRendererDispatcher p_i226002_1_) {
        super(p_i226002_1_);
        ...
        this.border = new ModelRenderer(64,64,0,0);
        this.border.addBox(-11.0F, -32.0F,-2.0F,22.0F, 1.0F,1.0F, 0.0F);
        this.border.addBox(-11.0F, -32.0F,-3.0F,22.0F, 1.0F,1.0F, 0.0F);
        this.border.addBox(-8.0F, -32.0F, -4.0F, 16.0F, 1.0F, 1.0F, 0.0F);
        this.border.addBox(-11.0F, -33.0F,-4.0F,22.0F, 1.0F,1.0F, 0.0F);
        this.border.addBox(-14.0F, -33.0F,-3.0F,28.0F, 1.0F,1.0F, 0.0F);
        this.border.addBox(-14.0F, -33.0F,-2.0F,28.0F, 1.0F,1.0F, 0.0F);
        this.border.addBox(-4.0F, -33.0F,-5.0F,8.0F, 1.0F,1.0F, 0.0F);
        this.border.addBox(-4.0F, -33.0F,-1.0F,8.0F, 1.0F,1.0F, 0.0F);
    ...
    public void render(ClaimFlagTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
        ...
        if (list != null) {
            ...
            RenderMaterial mat = new RenderMaterial(AtlasTexture.LOCATION_BLOCKS_TEXTURE, new ResourceLocation("block/gold_block"));
            IVertexBuilder ivertexbuilder = ModelBakery.LOCATION_BANNER_BASE.getBuffer(bufferIn, RenderType::getEntitySolid);
            IVertexBuilder bilda = mat.getBuffer(bufferIn, RenderType::getEntitySolid);
            ...
            this.border.render(matrixStackIn, bilda, combinedLightIn, combinedOverlayIn);
